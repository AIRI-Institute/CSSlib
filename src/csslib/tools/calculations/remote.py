...
class RemoteConnection:
    ...
    """
    def __init__(self, server_ip: str, port: int, username: str, password: str | None, host_keys_path: str | None, connection_attempts: int):
        """
    ...
    def __call__(self):
        """
            Returns instances of SSH and SFTP clients when the class is called.
            
            Return:
                tuple[SSHClient, SFTPClient]: SSH and SFTP clients.
        """
        return {'SSH': self.__ssh_client, 'SFTP': self.__sftp_client}
        
    def __del__(self):
        """
            Closes SSH and SFTP connections to the remote server when RemoteConnection object destroys.
        """
