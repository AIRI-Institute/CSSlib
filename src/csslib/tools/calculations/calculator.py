...
class Calculator:
    ...
    def __init__(self, data: str | DataLoader, inputs: InputSet | Any, calculations_path: str, cmd: str | list[str], 
                 ...
                 host_keys_path: str | None = None, max_workers: int | list[int] | None = None, max_connection_attempts: int = 5, **dataloader_fields):
        """
    ...
    def connect(self):
        ...
        for connection_info in zip(self.__server_ip, self.__port, self.__username, self.__password):
            connection = RemoteConnection(*connection_info, self.__host_keys_path, self.__max_connection_attempts)
