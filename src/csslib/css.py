...
class CSS:
    ...
    def generate_css(self):
        """
            Reproduces full pipeline of css structures generation:
            1. Reads structure from .cif.
            2. Evaluates substitution parameters.
            3. Creates and saves substitution template for the next css generation.
    ...
    def _evaluate_substitution_parameters(self) -> None:
        """
            Evaluates all possible combinations of substituted species' numbers.
        """
